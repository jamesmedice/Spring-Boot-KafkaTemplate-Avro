...
package com.medici.springboot.kafka.avro.model;
...
public class SampleReferenceStudent extends SpecificRecordBase implements SpecificRecord {
	...
	public static final Schema SCHEMA$ = (new Parser()).parse(
			"{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.medici.springboot.kafka.avro.model\",\"fields\":[{\"name\":\"studentName\",\"type\":\"string\"},{\"name\":\"studentId\",\"type\":\"string\"}]}");
